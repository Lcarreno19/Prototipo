<!DOCTYPE html>
  ...
  <!--       <script type="text/javascript" src="views/app/grafico2.js"></script> -->
        <script type="text/javascript" src="views/app/grafico.js"></script>

<!--         <script type="text/javascript" src="views/assets/prototipo/jquery-3.2.1.min,js"></script>
